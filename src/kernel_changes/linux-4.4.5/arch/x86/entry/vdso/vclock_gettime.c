...
extern u8 hpet_page __attribute__((visibility("hidden")));
...
static notrace const struct pvclock_vsyscall_time_info *get_pvti(int cpu)
{
	...
	pvti_base = (struct pvclock_vsyscall_time_info *)__fix_to_virt(
...
static notrace cycle_t vread_pvclock(int *mode)
{
   ...
   */
	...
	} while (unlikely(cpu != cpu1 || (pvti->pvti.version & 1) ||
